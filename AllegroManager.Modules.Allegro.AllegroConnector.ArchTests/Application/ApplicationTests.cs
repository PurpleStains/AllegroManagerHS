...
using AllegroManager.Modules.Allegro.AllegroConnector.ArchTests.SeedWork;
...
namespace AllegroManager.Modules.Allegro.AllegroConnector.ArchTests.Application
{
    [TestFixture]
